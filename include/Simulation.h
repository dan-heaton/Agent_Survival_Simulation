...
class Simulation {
    ...
    public:
        Simulation(int time_steps, int x_bound, int y_bound, int num_agents, int num_preadtors, int num_obstacles, 
                   int num_energies, bool seek_energy, bool output_csv=true, bool use_advanced_agents=false);
